...
export const SelectLang: React.FC<SelectLangProps> = (props) => {
 ...
 const handleClick = onItemClick
  ...
  const langMenu = (
    ...
    >
        <Menu.Item key={'el-GR'} style={menuItemStyle}>
          <span role='img' aria-label={allLangUIConfig['el-GR']?.label  || 'el-GR'}>
            {allLangUIConfig['el-GR']?.icon || "🌐"}
          </span>{' '}
          {allLangUIConfig['el-GR']?.label || 'el-GR'}
        </Menu.Item>
        ...
        <Menu.Item key={'uk-UA'} style={menuItemStyle}>
          <span role='img' aria-label={allLangUIConfig['uk-UA']?.label  || 'uk-UA'}>
            {allLangUIConfig['uk-UA']?.icon || "🌐"}
          </span>{' '}
          {allLangUIConfig['uk-UA']?.label || 'uk-UA'}
        </Menu.Item>
